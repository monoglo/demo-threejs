...
export default {
  ...
  methods: {
    initThreejs() {
      ...
      loader.load(
        `${process.env.BASE_URL}models/hulin.gltf`,
        gltf => {
          // console.info(gltf)
          ...
          this.nameLabel1.position.set(
            this.scene.getObjectByName('meter01').position.x + 100,
            this.scene.getObjectByName('meter01').position.y + 200,
            this.scene.getObjectByName('meter01').position.z - 200
          )
          ...
          this.nameLabel2.position.set(
            this.scene.getObjectByName('meter02').position.x + 100,
            this.scene.getObjectByName('meter02').position.y + 200,
            this.scene.getObjectByName('meter02').position.z
          )
          ...
          this.nameLabel3.position.set(
            this.scene.getObjectByName('meter03').position.x,
            this.scene.getObjectByName('meter03').position.y + 200,
            this.scene.getObjectByName('meter03').position.z + 100
          )

          this.scene.add(this.nameLabel3)
          this.drawLine(this.scene.getObjectByName('meter01').position, this.nameLabel1.position)
          this.drawLine(this.scene.getObjectByName('meter02').position, this.nameLabel2.position)
          this.drawLine(this.scene.getObjectByName('meter03').position, this.nameLabel3.position)
